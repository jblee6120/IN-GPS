...
MODEL                   = in_gps_estimation
MODULES                 = rt_matrx.c rt_printf.c rt_logging_simtarget.c in_gps_estimation.c in_gps_estimation_capi.c in_gps_estimation_data.c in_gps_estimation_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi_simtarget.c rtw_modelmap_utils_simtarget.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c raccel_sfcn_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = in_gps_estimation.exe
MAKEFILE                = in_gps_estimation.mk
MATLAB_ROOT             = C:\Program Files\MATLAB\R2021b
ALT_MATLAB_ROOT         = C:\PROGRA~1\MATLAB\R2021b
START_DIR               = C:\distro_file\IN-gps
S_FUNCTIONS_LIB         = 
NUMST                   = 2
NCSTATES                = 1
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = in_gps_estimation_ref.rsp
COMPILER_COMMAND_FILE     = in_gps_estimation_comp.rsp
